...
import 'package:flutter_amazone_clone/features/admin/services/admin_services.dart';
...
class _PostsScreenState extends State<PostsScreen> {
  ...
  final AdminSercies adminSercies = AdminSercies();
  ...
  fetchAllProducts() async {
    await adminSercies.fetchAllProducts(context);
    setState(() {});
  }

  void deleteProduct(Product product, int index) {
    adminSercies.deleteProduct(
        context: context,
        product: product,
        onSuccess: () {
